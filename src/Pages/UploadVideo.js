...
const VideoCapture = () => {
  ...
  const captureAndSendFrame = async () => {
    ...
    canvasRef.current.toBlob(async (blob) => {
      ...
      try {
        const response = await axios.post("https://along-table-appearing-panels.trycloudflare.com/video/predict_frame", formData, {
          headers: {
  ...
  const sendVideoToBackend = (videoFile) => {
    ...
    axios
      .post(" https://along-table-appearing-panels.trycloudflare.com/video/predict_video", formData, {
