...
const VideoCapture = () => {
  ...
  const captureAndSendFrame = async () => {
    ...
    canvasRef.current.toBlob(async (blob) => {
      ...
      try {
        const response = await axios.post("https://sq-mike-lesser-institute.trycloudflare.com/video/predict_frame", formData, {
          headers: {
  ...
  const sendVideoToBackend = (videoFile) => {
    ...
    axios
      .post(" https://sq-mike-lesser-institute.trycloudflare.com/video/predict_video", formData, {
