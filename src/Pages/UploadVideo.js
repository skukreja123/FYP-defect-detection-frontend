...
const VideoCapture = () => {
  ...
  const captureAndSendFrame = async () => {
    ...
    canvasRef.current.toBlob(async (blob) => {
      ...
      try {
        const response = await axios.post(" https://enables-possibility-wn-downloaded.trycloudflare.com/video/predict_frame", formData, {
          headers: {
  ...
  const sendVideoToBackend = (videoFile) => {
    ...
    axios
      .post("  https://enables-possibility-wn-downloaded.trycloudflare.com/video/predict_video", formData, {
